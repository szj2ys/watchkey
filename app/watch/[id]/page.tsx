  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Fetch analysis data (which includes video details)
        ...
        // The analysis endpoint returns the analysis with embedded video
            ...
            <section>
              ...
              <div className="flex items-center justify-between border-b border-slate-200 pb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold">{videoData.channel || 'WatchKey Official'}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                ...
                {analysisData.summary ? (
                  <p className="text-sm text-slate-600">{analysisData.summary}</p>
                ) : (
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                ...
                {typeof analysisData.transcript === 'string' && analysisData.transcript ? (
                  <div className="space-y-2 text-sm h-[120px] overflow-y-auto pr-2">
                    {analysisData.transcript.split('\n').map((line: string, index: number) => (
                      <div key={index} className="flex gap-3">
                        <span className="text-blue-500 font-medium underline cursor-pointer">[{index * 15}]</span>
              ...
              <div className="space-y-3">
                {Array.isArray(analysisData.chapters) && analysisData.chapters.length > 0 ? (
                  analysisData.chapters.map((chapter: string, index: number) => (
                    <div key={index} className={`group flex items-center gap-3 p-3 ${
                      index === 0 
